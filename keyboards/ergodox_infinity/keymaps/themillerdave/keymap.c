...
[_QWERTY] = LAYOUT_ergodox(
  // left hand
  KC_GESC,   KC_1,    KC_2,    KC_3,    KC_4,  KC_5, KC_LBRACKET,
  KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,  KC_T, RAISE,
  KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,  KC_G,
  KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,  KC_B, KC_LCTL,
  KC_RCTL, KC_GRV, KC_SCOLON, KC_HOME, KC_END,

                                                  KC_ESC,  TO(1),
                                                            KC_MINS,
                                      KC_LGUI,   KC_LALT,    KC_PGUP,

  // right hand
  KC_RBRACKET,      KC_6, KC_7,  KC_8,    KC_9,    KC_0,                KC_BSPACE,
  RAISE, KC_Y, KC_U,  KC_I,    KC_O,    KC_P,                KC_PIPE,
               KC_H, KC_J,  KC_K,    KC_L,    KC_QUOTE,           KC_ENT,
  KC_RALT,     KC_N, KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LEFT, KC_DOWN, KC_UP,               KC_RIGHT, LOWER,

  TO(1), KC_DEL,
  KC_PLUS,
  KC_PGDN, LOWER,   KC_SPACE
),
