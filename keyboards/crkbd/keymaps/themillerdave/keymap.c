...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      ...
      KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B,                                  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                          LCTL_T(KC_PGUP), KC_LALT, KC_LGUI,            KC_SPC, MO(_NUM), MO(_SYM)
    ),

	  [_NUM] = LAYOUT(
      KC_GESC, KC_1, KC_2, KC_3, KC_4, KC_5,                                  KC_6, KC_7, KC_8, KC_9, KC_0, KC_DEL,
      KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,                             KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN, KC_SCLN,
      LSFT_T(KC_CAPS), KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,                    KC_PGUP, KC_PGDN, KC_HOME, KC_END, KC_F11, MO(_ADJ),
                               KC_TRNS, KC_TRNS, KC_TRNS,              KC_TRNS, KC_TRNS, KC_TRNS
    ),

	  [_SYM] = LAYOUT(
      KC_GESC, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,                      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
      KC_TRNS, RGB_TOG, KC_MPLY, KC_MUTE, KC_VOLU, KC_VOLD,                   KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV,
      LSFT(KC_CAPS), KC_CALC, KC_MYCM, KC_MPRV, KC_MNXT, KC_TRNS,             KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, MO(_ADJ),
                              KC_TRNS, KC_TRNS, KC_TRNS,              KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [_ADJ] = LAYOUT(
      KC_ESC, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC,                       KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
      KC_TRNS, RGB_TOG, KC_MPLY, KC_MUTE, KC_VOLU, KC_VOLD,                   KC_MINS, KC_EQL, KC_LCBR, KC_RCBR, KC_PIPE, KC_GRV,
      RESET, KC_CALC, KC_MYCM, KC_MPRV, KC_MNXT, KC_TRNS,                     KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS, KC_TRNS,
                              KC_TRNS, KC_TRNS, KC_TRNS,              KC_TRNS, KC_TRNS, KC_TRNS
    ),
};
